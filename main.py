...
class Player(tk.Frame):
	...
	def track_widgets(self):
		...
		self.songtrack = tk.Label(self.track, font=("times new roman",16,"italic"),
						bg="white",fg="dark blue")
		self.songtrack['text'] = '--Music--'
		self.songtrack.config(width=30, height=1)
		self.songtrack.grid(row=1,column=0,padx=10)

	def control_widgets(self):
		self.loadSongs = tk.Button(self.controls, bg='light blue', fg='black', font=("times new roman",10,"italic"))
